function plantDiscovery(arr) {
  ...
  let sortedPlants = Object.keys(plantCollection).sort((a,b) =>{
    plantCollection[b].rarity - plantCollection[a].rarity || average(plantCollection[b].rating) - average(plantCollection[a].rating)
  });
